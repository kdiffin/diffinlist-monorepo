...
import { removeEmptyStrings } from "@diffinlist/api/helpers/removeEmptyStrings";
...
function EditSong() {
  ...
  return (
    ...
    <Dialog.Root open={toggleEditSong} onOpenChange={closeCreateSong}>
      <Dialog.Portal>
        <Dialog.Overlay className="data-[state=open]:animate-overlayShow fixed  inset-0 bg-neutral-900/40" />
