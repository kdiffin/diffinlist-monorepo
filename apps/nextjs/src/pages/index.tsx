...
const Home: NextPage = () => {
  ...
  return (
    <div className=" flex-col">
      {/* this is the header */}
      <div className=" neutral-lowkey-bg flex   items-center justify-center  px-8 py-14 sm:justify-start lg:px-14 ">
            ...
            users.map((userMap) => {
              return (
                <SectionCard
                  ...
                  data={{
                    pictureUrl: userMap.profileImageUrl,
                    authorName: "",
                    genre: "",

                    // this is basically the title of the  card
                    playlistName: userMap.username,
                  }}
                />
              );
            })
