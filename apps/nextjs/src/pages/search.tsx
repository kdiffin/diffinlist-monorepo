...
import { validQuery } from "@diffinlist/api/helpers/validateQuery";
  ...
  return (
    <div className="flex flex-col py-16 sm:px-12 md:px-20 ">
      ...
      <div className="flex flex-col gap-6 px-8  text-center lg:flex-row  lg:justify-between  ">
        ...
        <div className="lg:justify-normal flex flex-row flex-wrap items-center justify-between gap-8 lg:flex-col  ">
          <DropdownMenu.Root
